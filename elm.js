...
var author$project$Main$NoteModel = function (a) {
	return {$: 'NoteModel', a: a};
};
var author$project$Main$ToNote = function (a) {
	return {$: 'ToNote', a: a};
};
...
var author$project$Main$wrap = F3(
	function (toMessage, toModel, _n0) {
		var childModel = _n0.a;
		var childCmd = _n0.b;
		return _Utils_Tuple2(
			toModel(childModel),
			A2(elm$core$Platform$Cmd$map, toMessage, childCmd));
	});
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Page$Note$init = _Utils_Tuple2(
	{text: 'Dashboard'},
	elm$core$Platform$Cmd$none);
var author$project$Route$Note = {$: 'Note'};
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Route$Note, elm$url$Url$Parser$top)
		]));
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var _n0 = A2(
			...
			author$project$Route$Note,
			author$project$Route$fromUrl(url));
		return A3(author$project$Main$wrap, author$project$Main$ToNote, author$project$Main$NoteModel, author$project$Page$Note$init);
	});
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$Page$Note$subscriptions = function (model) {
...
var author$project$Main$subscriptions = function (model) {
	...
	return A2(
		...
		author$project$Main$ToNote,
		author$project$Page$Note$subscriptions(note));
};
var author$project$Page$Note$update = F2(
	function (message, model) {
		switch (message.$) {
			case 'EditNote':
				var newText = message.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{text: newText}),
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		if (_n0.a.$ === 'ToNote') {
			var childMessage = _n0.a.a;
			var childModel = _n0.b.a;
			return A3(
				author$project$Main$wrap,
				author$project$Main$ToNote,
				author$project$Main$NoteModel,
				A2(author$project$Page$Note$update, childMessage, childModel));
		} else {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		}
	});
var author$project$Page$Note$EditNote = function (a) {
	return {$: 'EditNote', a: a};
};
...
var author$project$Page$Note$view = function (model) {
	return A4(
		...
		_List_fromArray(
			[
				...
				author$project$Page$Note$EditNote('My notes'))
			]),
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$text(model.text)
			]));
};
...
var author$project$Main$view = function (model) {
	var childModel = model.a;
	return A2(
		rtfeldman$elm_css$Html$Styled$map,
		author$project$Main$ToNote,
		author$project$Page$Note$view(childModel));
};
